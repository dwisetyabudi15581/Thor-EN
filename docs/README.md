...
The official documentation set for **Thor — All-in-One Discord Community Bot** (v3.9.38).
...
| [CHANGELOG.md](../CHANGELOG.md)    | Full history of every version (v3.9.0 – v3.9.38)                                                                                              |
...
- **386 unit tests** — `node:test`, sandboxed (safe to run on a live server)
