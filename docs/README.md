...
The official documentation set for **Thor — All-in-One Discord Community Bot** (v3.13.0).
...
| [CHANGELOG.md](../CHANGELOG.md)    | Full history of every version (v3.9.0 – v3.13.0)                                                                                              |
