...
/**
 * v3.19.0: all warns in one guild (for the web dashboard — Moderation module).
 * The store is keyed per `${guildId}:${userId}`; this flattens it, sorts
 * newest first, and caps at `limit` so the dashboard payload stays light
 * even for servers with long histories.
 */
