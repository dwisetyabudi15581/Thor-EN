...
- 🟢 `README.md` — stale badge refreshed: **95** slash commands (test-pinned: `commandManager`/`dashParityV326`/`dashServer` all assert 95) & **903** unit tests (was 93/897 — numbers from the v4.1.0 split era).
